...
var geoCoder = function () {
    ...
    function getDistance(start, end, accuracy) {
        ...
        var distance = Math.round(Math.acos(Math.sin(latEnd) * Math.sin(latStart) + Math.cos(latEnd) * Math.cos(latStart) * Math.cos(lngStart - lngEnd)) * 6378137);
...
//# sourceMappingURL=mzCoder.js.map